...
router.post("/rooms", authMiddleware, adminAuthenticationMiddleware, createRoom);
router.put("/rooms/:id", authMiddleware, adminAuthenticationMiddleware, updateRoom);
router.delete("/rooms/:id", authMiddleware, adminAuthenticationMiddleware, deleteRoom);
